...
class Unit {
  ...
  printData() {
    document.querySelector(
      `#splash`
    ).innerHTML = `<img class="cost${this.cost}" src="https://ddragon.leagueoflegends.com/cdn/13.1.1/img/tft-champion/${this.icon}">`;
    ...
    document.querySelector(
      `#magic_resist`
    ).innerText = `Magic Resist: ${this.magicresist}`;
    document.querySelector(
      `#mana`
    ).innerText = `Mana: ${this.startingmana}/${this.totalmana}`;
